...
@section('content')
        ...
        <div class="container margin_120_100 home_intro">
            <div class="row justify-content-center d-flex align-items-center">
                <div class="col-lg-5 text-lg-center d-none d-lg-block" data-cue="slideInUp">
                    <figure>
                        <img src="{{ asset('assets/frontend/img/METRO-LOGO.png') }}" data-src="{{ asset('assets/frontend/img/METRO-LOGO.png') }}" width="354" height="440"
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-5 col-md-6 text-center">
                        <div class="box_1" data-cue="slideInUp">
                            ...
                            <p>Breakfast and welcome break </p>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12" data-cue="slideInUp">
                        <div class="main_title" id="reservation">
                            <span><em></em></span>
    ...
    <h2>Luton Events at The Metro</h2>
        <div class="row">
            <div class="col-xl-4">
                <a href="{{ route('menu') }}" class="img_container">
                    <img src="{{ asset('assets/frontend/img/banner_1.jpg') }}" class="lazy">
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <h3>Tuesday Talent Showcase</h3>
                        <p> Date: Tue 30 Apr, 12:00</p>
                        <p>The Metro, Luton Campus </p>
                        <p>View event</p>
                    </div>
                </a>
            </div>
            <div class="col-xl-4">
                <a href="menu.html" class="img_container">
                    ...
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <h3>Games night and Toast Tuesday</h3>
                        <p> Date: Tue 30 Apr, 16:00</p>
                        <p>Location: The Metro, Luton </p>
                        <p>View event</p>
                    </div>
                </a>
            </div>
            <div class="col-xl-4">
                <a href="menu.html" class="img_container">
                    ...
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <h3>Achievement Awards - English as a Foreign Language</h3>
                        <p> Date: Thu 2 May, 14:00</p>
                        <p>Location: The Metro, Luton Campus </p>
                        <p>View event</p>
                    </div>
                </a>
            </div>
