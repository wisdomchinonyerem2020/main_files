        ...
        <form action="{{ route('admin.general.store', $general ? 'update':'create') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">The Metro cafe & Kitchen</label>
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">The Metro cafe & Kitchen Logo</label>
                    <div class="col-sm-12 col-md-7">
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">About The Metro cafe & Kitchen</label>
                    <div class="col-sm-12 col-md-7">
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">The Metro cafe & Kitchen Story </label>
                    <div class="col-sm-12 col-md-7">
